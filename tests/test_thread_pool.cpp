...
int main() {
    ...
    // Teste 4: Thread-safety (contador compartilhado)
    {
    ...
    // Teste 5: Tarefas com durações diferentes
    {
    ...
    // Teste 6: Performance - Speedup com paralelismo
    {
    ...
    std::cout << "  ThreadPool:\n";
    std::cout << "    • Criação e destruição: ✅\n";
    std::cout << "    • Execução de tarefas: ✅\n";
    std::cout << "    • Thread-safety: ✅\n";
    std::cout << "    • Performance (speedup): ✅\n\n";
